...
module ActsAsSolr #:nodoc:
  ...
  module ClassMethods
    ...
    #            => 0.12321548
    # 
    def find_by_solr(query, options={}, find_options={})
      data = parse_query(query, options, find_options)
      return parse_results(data, options, find_options) if data
    end
    ...
    # 
    def multi_solr_search(query, options = {}, find_options = {})
      ...
      data = parse_query(query, options, find_options, models<<")")
      result = []
      if data
        docs = data.docs
